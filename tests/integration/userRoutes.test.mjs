...
describe('Routes - /api/v1/users', () => {
  ...
  describe('Update Me', () => {
    ...
    it('should successfully update current user data if conditions met and ignore changes requested for password property', () => {});
    it('should successfully update current user data if conditions met and ignore changes requested for passwordConfirm property', () => {});
    it('should successfully update current user data if conditions met and ignore changes requested for passwordChangedAt property', () => {});
    it('should successfully update current user data if conditions met and ignore changes requested for emailVerificationToken property', () => {});
    it('should successfully update current user data if conditions met and ignore changes requested for emailVerificationTokenExpires property', () => {});
    it('should successfully update current user data if conditions met and ignore changes requested for csrfToken property', () => {});
    it('should successfully update current user data if conditions met and ignore changes requested for csrfTokenExpires property', () => {});
    it('should successfully update current user data if conditions met and ignore changes requested for verified property', () => {});
    it('should successfully update current user data if conditions met and ignore changes requested for active property', () => {});
